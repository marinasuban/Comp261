...
public abstract class GUI {
	...
	private void initialise() {
		...
		JButton ArticulationPoint = new JButton("Articulation");
		...
		JButton Bike = new JButton("No Bike");
		...
		JButton Walk = new JButton("No Pedestrian");
		...
		JButton Car = new JButton("No Car");
