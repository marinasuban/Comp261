...
public abstract class GUI {
	...
	/**
	 * called for Trie search.
	 */
	protected abstract void onSearchTrie();
	...
	protected abstract void onComboBoxSelect(String item);
	...
	private JComboBox stopSearchResultsDropDown;

	private JTextField search;
	private JFileChooser fileChooser;
	public HashMap<String, Stops> stopsByName = new HashMap<String, Stops>();
	...
	public void updateStopsInComboBox(HashSet<Stops> stops) {
		stopSearchResultsDropDown.removeAllItems();
		for (Stops s : stops) {
			stopSearchResultsDropDown.addItem(s.getName());
		}
	}
	...
	private void initialise() {
		...
		JButton quadTree = new JButton("Challenge");
		quadTree.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
//				if (Maps.quadTreeOn == true) {
//					Maps.quadTreeOn = false;
//				} else {
//					Maps.quadTreeOn = true;
//				}
				Maps.quadTreeOn = !Maps.quadTreeOn; //toggle
				redraw();
			}
		});

		/** drop down box */
		stopSearchResultsDropDown = new JComboBox(stopsByName.keySet().toArray());
		stopSearchResultsDropDown.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JComboBox cb = (JComboBox) e.getSource();
				String item = (String) cb.getSelectedItem();
				// getTextOutputArea().setText(item);
		...
		controls.add(search);
		controls.add(stopSearchResultsDropDown);
